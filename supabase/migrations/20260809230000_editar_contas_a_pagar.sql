...
revoke all on function public.editar_conta_a_pagar(uuid, uuid, text, numeric) from public;
grant execute on function public.editar_conta_a_pagar(uuid, uuid, text, numeric) to authenticated;
